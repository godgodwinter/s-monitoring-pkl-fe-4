<template>
  <div>
    <div class="bg-white p-3 shadow-sm rounded-sm hidden lg:block">
      <!-- About Section -->
            ...
            <div class="flex">
              <div class="w-1/3 text-center px-6">
                ...
                >
                  ...
                  <div
                    class="w-2/3 bg-sky-200 h-24 flex flex-col items-center justify-center px-1 rounded-r-lg body-step"
                  >
                    <h2 class="font-bold text-sm">Mendaftar</h2>
              ...
              <div class="w-1/3 text-center px-6">
                ...
                >
                  ...
                  >
                    <h2 class="font-bold text-sm">Mengisi Data PKL</h2>
                    <p class="text-xs text-gray-600">Tempat PKL dan Pembimbing</p>
                  </div>
                </div>
              </div>
              <div class="flex-1 flex items-center justify-center">
              ...
              <div class="w-1/3 text-center px-6">
                ...
                >
                  ...
                  <div
                    class="w-2/3 bg-gray-200 h-24 flex flex-col items-center justify-center px-1 rounded-r-lg body-step"
                  >
                    <h2 class="font-bold text-sm">Konfirmasi</h2>
