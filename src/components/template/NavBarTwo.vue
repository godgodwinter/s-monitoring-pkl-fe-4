...
const isSideBarActive = computed(function () {
  return store.state.isSideBarActive;
});

let getDataAuth = ref();
// const dataAuth = computed(function () {
//   return store.state.dataAuth;
// });
function toggleMenu() {
  isMenuActive.value = !isMenuActive.value;
}
function toggleSideBar() {
  store.commit("setSideBar", !isSideBarActive.value);
}
    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <router-link :to="{ name: 'AdminDashboard' }" href="#" class="text-xl font-bold flex items-center lg:ml-2.5">
            <!-- <img
        ...
        <div class="flex items-center">
          <button @click="toggleSideBar()" id="toggleSidebarMobileSearch" type="button"
