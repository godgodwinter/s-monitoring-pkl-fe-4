...
const getData = async () => {
  try {
    const response = await Api.get("admin/pendaftaranpkl/list/prosespengajuantempatpkl");
  ...
  <div class="bg-white p-3 shadow-sm rounded-sm">
    ...
    <div class="bg-white p-3 shadow-sm rounded-sm">
      <div class="flex items-center space-x-2 font-semibold text-gray-900 leading-8">
        ...
        <span class="tracking-wide">Data Siswa dalam Proses Pengajuan Tempat PKL</span>
      </div>
